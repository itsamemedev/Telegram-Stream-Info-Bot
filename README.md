...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 26.124 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core
...
`bot.py` hat 26.124 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
26.124 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
