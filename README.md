...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 22.701 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core
...
`bot.py` hat 22.701 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
22.701 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
