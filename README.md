...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 23.586 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core
...
`bot.py` hat 23.586 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
23.586 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
