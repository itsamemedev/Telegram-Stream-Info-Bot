...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 26.440 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 42 eigene Routen"]:::core
...
`bot.py` hat 26.440 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
26.440 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
