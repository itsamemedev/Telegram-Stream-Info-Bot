...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 25.949 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core
...
`bot.py` hat 25.949 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
| Fachmodule | 120 in `nc/` (+36 in `nc/routes/`, +3 in `nc/intel/`), 10 in `brain/` |
| Sentinel-Agenten | 13 |
...
25.949 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
