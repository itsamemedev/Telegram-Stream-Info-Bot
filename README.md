...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 23.092 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core
...
`bot.py` hat 23.092 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
(34 in `bot.py`, 327 in `nc/routes/`), 45 Slash-Commands, 484 Funktionen,
...
23.092 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
