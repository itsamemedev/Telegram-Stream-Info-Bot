...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 23.659 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core

    BOT -->|configure| NC["nc/ — 135 Fachmodule<br/>Schema · OAuth · Restream<br/>Ledger · Moderation · Intel"]:::lib
...
Alle Einstellungen leben in `.env`. Die Vorlage `.env.example` kennt **rund 523 Variablen** — das Minimum ist klein:
...
`bot.py` hat 23.659 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
| Regel | Warum |
|---|---|
| **`.env` liegt nie im Repo und nie im Archiv** | ~523 Variablen inkl. Cookies, OAuth-Tokens und Stream-Keys |
...
23.659 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
