...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 23.883 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core
...
`bot.py` hat 23.883 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
(34 in `bot.py`, 330 in `nc/routes/`), 60 Slash-Commands, 540 Funktionen,
...
23.883 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
