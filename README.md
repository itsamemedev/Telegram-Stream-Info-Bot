...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 25.898 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core

    BOT -->|configure| NC["nc/ — 122 Fachmodule<br/>Schema · OAuth · Restream<br/>Ledger · Moderation · Intel"]:::lib
...
`bot.py` hat 25.898 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
(34 in `bot.py`, 327 in `nc/routes/`), 45 Slash-Commands, 471 Funktionen,
...
| Fachmodule | 122 in `nc/` (+36 in `nc/routes/`, +3 in `nc/intel/`), 10 in `brain/` |
| Sentinel-Agenten | 13 |
...
25.898 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
