...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 22.699 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core
...
Alle Einstellungen leben in `.env`. Die Vorlage `.env.example` kennt **rund 514 Variablen** — das Minimum ist klein:
...
`bot.py` hat 22.699 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
| Regel | Warum |
|---|---|
| **`.env` liegt nie im Repo und nie im Archiv** | ~514 Variablen inkl. Cookies, OAuth-Tokens und Stream-Keys |
...
22.699 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
