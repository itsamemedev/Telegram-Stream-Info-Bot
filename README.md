...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 29.347 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 153 eigene Routen"]:::core
...
`bot.py` hat 29.347 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
29.347 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
