...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 27.218 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 81 eigene Routen"]:::core

    BOT -->|configure| NC["nc/ — 105 Fachmodule<br/>Schema · OAuth · Restream<br/>Ledger · Moderation · Intel"]:::lib
    NC --> RT["nc/routes/ — 31 Blueprints<br/>278 weitere API-Routen"]:::lib
...
`bot.py` hat 27.218 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
(81 in `bot.py`, 278 in `nc/routes/`), 45 Slash-Commands, 479 Funktionen,
...
│
├── nc/                       105 Fachmodule (bot-frei, configure()-Injection)
...
| Flask-Routen | 359 (81 in `bot.py` · 278 in `nc/routes/`) |
| Discord-Slash-Commands | 45 |
| Fachmodule | 105 in `nc/` (+31 in `nc/routes/`, +3 in `nc/intel/`), 10 in `brain/` |
| Sentinel-Agenten | 13 |
...
27.218 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
...
`nc/routes/` trägt heute 31 Blueprints mit 278 API-Routen, die nicht mehr im
Monolithen stehen.
