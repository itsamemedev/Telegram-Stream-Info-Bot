...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 23.553 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core
...
Alle Einstellungen leben in `.env`. Die Vorlage `.env.example` kennt **rund 522 Variablen** — das Minimum ist klein:
...
`bot.py` hat 23.553 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
| Regel | Warum |
|---|---|
| **`.env` liegt nie im Repo und nie im Archiv** | ~522 Variablen inkl. Cookies, OAuth-Tokens und Stream-Keys |
...
23.553 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
