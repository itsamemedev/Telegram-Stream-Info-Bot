...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 29.306 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 149 eigene Routen"]:::core

    BOT -->|configure| NC["nc/ — 94 Fachmodule<br/>Schema · OAuth · Restream<br/>Ledger · Moderation · Intel"]:::lib
    NC --> RT["nc/routes/ — 23 Blueprints<br/>210 weitere API-Routen"]:::lib
...
`bot.py` hat 29.306 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
(149 in `bot.py`, 210 in `nc/routes/`), 45 Slash-Commands, 510 Funktionen,
...
| Flask-Routen | 359 (149 in `bot.py` · 210 in `nc/routes/`) |
| Discord-Slash-Commands | 45 |
| Fachmodule | 94 in `nc/` (+23 in `nc/routes/`, +3 in `nc/intel/`), 10 in `brain/` |
| Sentinel-Agenten | 13 |
...
29.306 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
...
`nc/routes/` trägt heute 23 Blueprints mit 210 API-Routen, die nicht mehr im
Monolithen stehen.
