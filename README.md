...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 25.702 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core
...
`bot.py` hat 25.702 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
25.702 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
