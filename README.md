...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 24.246 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 34 eigene Routen"]:::core
...
`bot.py` hat 24.246 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
24.246 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
