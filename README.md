...
flowchart TB
    ...
    BOT["bot.py<br/>Monolith · 26.585 Zeilen<br/>Scraper · Recorder · Restream<br/>Flask-Dashboard · 42 eigene Routen"]:::core

    BOT -->|configure| NC["nc/ — 118 Fachmodule<br/>Schema · OAuth · Restream<br/>Ledger · Moderation · Intel"]:::lib
...
`bot.py` hat 26.585 Zeilen. Es wird **nie** ganz gelesen und **nie**
...
(81 in `bot.py`, 278 in `nc/routes/`), 45 Slash-Commands, 483 Funktionen,
...
| Fachmodule | 118 in `nc/` (+34 in `nc/routes/`, +3 in `nc/intel/`), 10 in `brain/` |
| Sentinel-Agenten | 13 |
...
26.585 Zeilen**. Die Datei ist der Engpass des Projekts. Die Messlatte dafür ist
...
`nc/routes/` trägt heute 34 Blueprints mit 317 API-Routen, die nicht mehr im
Monolithen stehen.
