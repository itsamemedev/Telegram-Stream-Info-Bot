...
`bot.py` has **26,805 lines / 1.3 MB ≈ 338,000 tokens**. That file is **never**
...
`find` answers from `.claude/INDEX.md` — 359 routes (67 in `bot.py`, 292 in
...
## Layout
    ...
    nc/                  112 domain modules: db, scraping, restream, oauth, ledger, i18n, …
    nc/routes/           33 Flask blueprints with 292 further API routes
