...
`bot.py` hat **23.513 Zeilen / 1,2 MB ≈ 295.000 Token**. Diese Datei wird
...
`nc/routes/`), 45 Slash-Commands, 492 Funktionen mit Zeilennummern. Nach Änderungen an Routen, Commands oder
...
## Aufbau
    ...
    nc/                  135 Fachmodule: db, scraping, restream, oauth, ledger,
                         i18n, …
...
`.env` hat rund 521 Variablen und enthält Cookies, OAuth-Tokens und Stream-Keys — sie
