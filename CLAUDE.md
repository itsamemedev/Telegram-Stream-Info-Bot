...
`bot.py` hat **29.112 Zeilen / 1,5 MB ≈ 385.000 Token**. Diese Datei wird
...
`find` antwortet aus `.claude/INDEX.md` — 359 Routen (143 in `bot.py`, 216 in
...
## Aufbau
    ...
    bot.py               Monolith: Telegram + Discord (45 Slash-Commands),
                         Flask-Dashboard (143 eigene Routen), Scraper, Recorder,
    ...
    nc/                  95 Fachmodule: db, scraping, restream, oauth, ledger,
                         i18n, …
    nc/routes/           24 Flask-Blueprints mit 216 weiteren API-Routen
