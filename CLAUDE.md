...
`bot.py` hat **26.425 Zeilen / 1,3 MB ≈ 333.000 Token**. Diese Datei wird
...
`find` antwortet aus `.claude/INDEX.md` — 359 Routen (42 in `bot.py`, 317 in
`nc/routes/`), 45 Slash-Commands, 479 Funktionen mit Zeilennummern. Nach Änderungen an Routen, Commands oder
...
## Aufbau
    ...
    nc/                  115 Fachmodule: db, scraping, restream, oauth, ledger,
                         i18n, …
    nc/routes/           34 Flask-Blueprints mit 317 weiteren API-Routen
