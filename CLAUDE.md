...
`bot.py` hat **26.396 Zeilen / 1,3 MB ≈ 333.000 Token**. Diese Datei wird
...
`find` antwortet aus `.claude/INDEX.md` — 360 Routen (39 in `bot.py`, 321 in
...
## Aufbau
    ...
    nc/                  119 Fachmodule: db, scraping, restream, oauth, ledger,
                         i18n, …
    nc/routes/           35 Flask-Blueprints mit 321 weiteren API-Routen
