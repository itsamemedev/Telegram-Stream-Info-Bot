...
`bot.py` hat **22.854 Zeilen / 1,2 MB ≈ 294.000 Token**. Diese Datei wird
...
`nc/routes/`), 45 Slash-Commands, 480 Funktionen mit Zeilennummern. Nach Änderungen an Routen, Commands oder
...
`.env` hat rund 516 Variablen und enthält Cookies, OAuth-Tokens und Stream-Keys — sie
