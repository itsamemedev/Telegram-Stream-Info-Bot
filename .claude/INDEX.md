...
```
  9567  GET              /                                                dashboard
 11565  GET              /api/abo/status                                  api_abo_status
 11519  DELETE           /api/annotations/<int:aid>                       api_annotation_delete
 10355  GET              /api/automation/status                           api_automation_status
 10377  POST             /api/automation/toggle                           api_automation_toggle
 18685  GET              /api/channel/categories                          api_channel_categories
 18691  POST             /api/channel/set                                 api_channel_set
 18538  GET              /api/channels/status                             api_channels_status
 18212  GET/DELETE       /api/clip/<fn>                                   api_clip_file
 18195  GET              /api/clips                                       api_clips
 18241  POST/DELETE      /api/clips/clear                                 api_clips_clear
 18120  GET              /api/debug/threads                               api_debug_threads
 11530  GET              /api/events                                      api_events
 11014  GET              /api/events/stream                               api_events_stream
 10841  GET              /api/health                                      api_health
 18154  POST             /api/highlights/config                           api_highlights_config
  9501  POST             /api/login                                       dashboard_login_submit
 11855  GET/POST         /api/notifications/quiet-hours                   api_quiet_hours
 10929  GET              /api/notify/status                               api_notify_status
 10940  POST             /api/notify/test                                 api_notify_test
 11619  GET              /api/proxy/heatmap                               api_proxy_heatmap
 11596  GET              /api/proxy/trend                                 api_proxy_trend
 18261  GET              /api/tts/<fn>                                    api_tts_file
 19036  GET              /api/upload_window                               api_upload_window
 11131  GET              /archive/<int:eid>/download                      archive_download
 11159  GET              /download/<int:recording_id>                     download
 11088  GET              /health                                          health
 18078  GET              /healthz                                         healthz
  9492  GET              /login                                           dashboard_login_page
  9522  GET              /logout                                          dashboard_logout
  9529  GET              /manifest.webmanifest                            pwa_manifest
 19009  GET              /overlay                                         overlay_page
  9553  GET              /pwa-icon-<variant>.png                          pwa_icon
...
```
 23335-23357  _abbruch_datenbank_unlesbar
  2577-2578   _abo_key
  2598-2616   _abo_probe_dump
 15033-15040  _ad_allowlist
 16009-16015  _agent_for
 16018-16034  _ai_telemetry
 16529-16547  _alert
 19895-19945  _alert_monitor_loop
 20297-20359  _announce_loop
  3209-3219   _anthropic_key
  3226-3228   _anthropic_model
  9187-9190   _arg_int
  2569-2574   _as_dict
 23085-23094  _async_exc_handler
 16710-16732  _audio_tap_cmd
 17269-17328  _audio_tap_melden
 16746-16770  _audio_tap_sammler
  9355-9424   _auth_cookie
  9322-9351   _auth_guard
  1806-1811   _auto_on
 17940-17958  _auto_restream_loop
 13035-13077  _avatar_frames_laden
 21377-21392  _azrael_broadcast_reply
 21277-21299  _azrael_chat_reply
 21249-21274  _azrael_chat_should_reply
 21305-21307  _azrael_gate_cfg
 16039-16053  _azrael_live_state
 18922-18936  _azrael_overlay_state
 16411-16465  _azrael_proactive_loop
 15857-15913  _azrael_reaction_to_chats
 21310-21317  _azrael_reply_all_chats
 21236-21246  _azrael_self_names
 21345-21374  _azrael_send_to
 12996-13032  _azrael_spricht
 16059-16080  _azrael_system
 20029-20032  _backup_active
 20110-20123  _backup_loop
 23158-23167  _brain_crowdsec_snap
 19816-19825  _brain_growth_loop
  9746-9773   _brain_growth_snapshot
  2511-2531   _brain_hint_delay
 23230-23265  _brain_moderation_snap
  6088-6116   _brain_notify
 23268-23290  _brain_recording_snap
 23170-23227  _brain_restream_health
 23293-23306  _brain_tiktok_status_snap
 10993-11010  _browser_push
  6128-6215   _build_daily_summary
 13356-13360  _build_restream_cmd
  4910-4937   _can_stop_tracking
  1919-1941   _capture_set_cookies
 11673-11676  _cfg_get
 11679-11681  _cfg_set
 18646-18681  _channel_set_all
 12224-12227  _chat_connected
 12230-12246  _chat_disconnected
  8254-8265   _chat_is_forum
 17076-17101  _chat_listener_abbauen
 12266-12268  _chat_sanitize
 12209-12221  _chat_stat
 12249-12252  _chat_stats_snapshot
  3512-3524   _check_ai_models_sync
 10028-10071  _classify_pool_anonymity
 10074-10091  _classify_pool_anonymity_bg
   856-878    _claude_chat_sync_metered
  9216-9223   _client_ip
 20443-20470  _clip_prune
 20473-20483  _clip_recfile_for
 20893-20899  _clip_should_velocity
 20524-20606  _clip_to_discord
  3405-3414   _close_ai_session
 21423-21438  _cohost_broadcast
 21408-21409  _cohost_cfg
 21464-21476  _cohost_fire_highlight
 21412-21420  _cohost_gate
 21441-21461  _cohost_highlight
  9676-9678   _conv_messages
  6487-6548   _cookie_alarm_loop
  2010-2015   _cookie_autofetch_info
  1993-1997   _cookie_autorefresh_info
  1896-1900   _cookie_header
  2027-2060   _cookies_selbst_holen
  3740-3752   _create_index_safe
 19368-19474  _crowdsec_status
 19314-19365  _crowdsec_via_lapi
 19218-19236  _cscli_bin
 19245-19258  _cscli_path
  6377-6402   _daily_summary_loop
 19276-19293  _darf_journal_lesen
 11174-11195  _dashboard_adresse
 19869-19892  _db_maintenance_loop
  6346-6374   _db_vacuum_loop
 15056-15080  _detect_foreign_ad
  1541-1552   _diag_path_owner
 16317-16361  _director_finalize
 17258-17265  _director_for
 16266-16314  _director_mark
 20758-20761  _disc_state_get
 20764-20771  _disc_state_set
 19797-19806  _discord_bot_starten
 19761-19772  _discord_einladung_merken
 19809-19813  _discord_invite
 19775-19794  _discord_kontext
 20719-20755  _discord_live_thread
 16468-16480  _discord_notify
 19733-19758  _discord_ops_alert
 20617-20715  _discord_post_user
 20362-20368  _discord_stop
  6405-6482   _disk_alarm_loop
 22888-22937  _disk_autoclean
 22940-22953  _disk_guard_loop
 12974-12981  _drossel_hoeher
 12970-12971  _drossel_stufe
 12984-12992  _drossel_zuruecksetzen
 11351-11353  _dump_all_threads
  9954-10017  _enrich_proxies_with_geo
  2089-2150   _ensure_cookie_file_netscape
  8313-8316   _ensure_notify_topic
 10198-10235  _ensure_proxy_ready
  8267-8294   _ensure_topic
   705-707    _env_int
   710-712    _env_int_range
 16513-16526  _event_webhook
 12024-12037  _evolution_loop
  5530-5564   _extract_file_payload
  2222-2224   _extract_urls_from_streamurl_node
 19261-19268  _f2b_sudo_hint
  4374-4384   _fehler_text
  9855-9873   _fetch_proxy_list
 17045-17073  _fetch_tiktok_room_id
   788-791    _ff_cmd
 12803-12808  _find_chromium
  3129-3131   _find_external_recorder
  2227-2229   _find_stream_urls
 11724-11749  _fire_webhooks
  7314-7323   _fork_safe
   889-902    _freeai_chat_sync_metered
 19307-19311  _geo_lookup_ips
  3393-3402   _get_ai_session
  7147-7187   _get_live_info
  2843-2850   _get_resolve_semaphore
  7596-7968   _handle_single_tracking
 22710-22712  _hb
 22715-22732  _hb_while
 12280-12282  _highlight_cfg
 12285-12314  _highlight_observe
 12811-12829  _htmlov_screenshot_cmd
 16772-16782  _httpx_proxy
 11757-11769  _in_quiet_hours
 23321-23332  _init_db_oder_abbruch
 23899-23930  _install_fast_eventloop
  9082-9136   _install_fast_json
 11356-11372  _install_faulthandler
 17986-17995  _intel_ensure_schema
 18033-18068  _intel_index_loop
 18007-18017  _intel_index_one
 17998-18004  _intel_semantic
  4899-4908   _is_authorized
  7497-7503   _is_dead
  2212-2214   _is_hevc
 19296-19298  _is_private_ip
  1705-1712   _is_process_running
  6118-6125   _is_quiet_hours
  1334-1343   _is_upload_window
  4239-4254   _iso
  9171-9184   _json_error_handler
  6340-6341   _kick_broadcaster_id
  6252-6294   _kick_follower_count
  6236-6239   _kick_slug
 10806-10813  _kick_user_token
 23309-23318  _kickmod_boot
  3829-3832   _kind_from_filename
 11786-11788  _latest_popularity
 17654-17703  _live_react_loop
 17331-17643  _live_react_worker
 15916-15927  _live_transcript_push
 17645-17652  _live_users
 16364-16408  _living_title_loop
 20035-20107  _local_backup_scan
  9153-9167   _log_5xx
   778-785    _log_sicher
 13368-13380  _looks_like_codec_err
 13363-13365  _looks_like_source_expired
  7364-7394   _loop_fehler
 11376-11385  _loop_heartbeat
 22680-22707  _loop_lag_monitor
 11388-11456  _loop_watchdog_thread
 15796-15810  _loyalty_add
 15787-15793  _loyalty_get
 15813-15821  _loyalty_top
 11896-11898  _manual_donations_total
  4581-4600   _manual_status
  7505-7506   _mark_dead
 10474-10490  _marketing_loop
 21324-21342  _maybe_handle_command
 23039-23063  _maybe_hype_clip
 20412-20440  _meme_klassifizieren
  3707-3730   _migrate_columns
 21603-21614  _mod_is_exempt
 21617-21622  _mod_warn_first
 21625-21628  _mod_warn_text
 12064-12072  _modlog
  1034-1036   _multistream_targets
  7326-7327   _nc_create_subprocess_exec
  7330-7331   _nc_create_subprocess_shell
 10743-10760  _news_loop
 12091-12093  _normalize_ingest
  2442-2459   _note_check_duration
  8307-8310   _notify_topic_name
 15942-15950  _oracle_memories
 16215-16249  _oracle_memorize
 15953-15966  _oracle_persona
 15935-15939  _oracle_recent_text
 12437-12438  _ov_atomic_write
 12428-12430  _ov_bar
 14959-14971  _ov_clip_text
 12433-12434  _ov_oneline
 18973-19002  _overlay_push
 12757-12800  _overlay_render_size
 12160-12164  _overlay_session_reset
 18938-18940  _overlay_src_ok
 15043-15053  _own_invites
 12752-12754  _parse_size
 19482-19562  _parse_ssh_attacks
  6749-6782   _pause_resume_cmd
  1947-1991   _persist_refreshed_cookies
  1850-1882   _pick_checked_pull_proxy
  9252-9265   _pin_auth_value
  9311-9312   _pin_clear_fail
  9291-9294   _pin_locked
  9297-9308   _pin_note_fail
  9268-9288   _pin_ok
 18782-18807  _piper_pick_model
 18867-18916  _piper_say
 11686-11721  _post_json_threaded
 12731-12749  _probe_video_size
  1733-1750   _proc_is_recorder
 10167-10195  _proxy_pool_refresh_loop
  1816-1847   _proxy_report_recording
 11341-11343  _prune_stall_dumps
 10544-10665  _public_stats
  2018-2024   _pull_proxy_still
 16484-16510  _push_notify
  9471-9473   _pwa_dir
  9924-9939   _quick_validate_proxy
 11752-11754  _quiet_hours_config
  9436-9469   _rate_guard
 15757-15763  _react_warn
  7234-7273   _reap_proc
  8537-8604   _rec_auto_abschalten
  8484-8534   _rec_frueh_getrennt
  8371-8429   _rec_kategorie_melden
  8432-8481   _rec_totstreak_fortschreiben
  2482-2504   _record_check_outcome
   773-775    _redact_stream_urls
 10094-10164  _refresh_proxy_pool
  2259-2350   _resolve_via_html
  2623-2820   _resolve_via_webcast_api_v2
  2883-2950   _resolve_via_ytdlp
 20933-21062  _resolve_youtube_ingest
  2238-2256   _resolver_stumm
 12143-12154  _restream_active_sources
 13080-13204  _restream_avatar_feeder_start
 13207-13216  _restream_avatar_feeder_stop
 17104-17222  _restream_chat_guardian
 12317-12389  _restream_chat_push
 12414-12423  _restream_chat_push_async
 12832-12941  _restream_html_overlay_start
 12944-12957  _restream_html_overlay_stop
 12102-12125  _restream_overlay_files
 17707-17739  _restream_platform_state
 17902-17937  _restream_resume_after_restart
 13264-13322  _restream_tts_enqueue_wav
 12693-12725  _restream_tts_feeder
 12690-12691  _restream_tts_fifo_path
 13219-13246  _restream_tts_start
 13248-13262  _restream_tts_stop
 17745-17899  _restream_verify_loop
 20000-20012  _retention_loop
 19994-19997  _retention_scan
  2580-2582   _room_is_abo
  5568-5685   _run_ai_call
 11479-11492  _run_async_from_flask
 19301-19304  _run_priv
 23887-23895  _run_selfcheck_and_exit
 20015-20026  _s3_client
  7532-7583   _safe_send
  4507-4523   _sample_net_throughput
  2534-2555   _schedule_next_check
 19948-19991  _scheduler_loop
  3733-3737   _schema_pk
 11496-11501  _scraper_session
 21631-21670  _screen_full
 10857-10894  _sec_headers
  2217-2219   _select_stream_from_data_section
 23665-23884  _selfcheck
  8319-8353   _send_live_notice
  1357-1361   _should_defer_upload
 20486-20521  _shrink_for_discord
  9476-9488   _sicheres_ziel
 19828-19866  _sicherheits_erinnerung_loop
 22960-22977  _sign_health_check
 22980-22999  _sign_health_loop
  4257-4282   _sitzung_bestimmen
  7343-7354   _spawn
 24305-24335  _spawn_from_flask
 16784-17042  _start_chat_listener
 11459-11476  _start_loop_watchdog
 10692-10738  _stats_loop
 10671-10674  _stats_output_path
 10677-10689  _stats_write
 18819-18833  _stimme_saubern
 18840-18864  _stimme_schon_gesagt
  8047-8063   _storage_cleanup_loop
 23019-23026  _story_for
  3154-3160   _stream_url_expiry
  3162-3167   _stream_url_ttl
 15006-15013  _streamer_persona_get
 20132-20254  _system_backup
 20263-20293  _system_backup_loop
 11301-11319  _task_auf_bot_schleife
  7397-7443   _telegram_polling_fehler
  9876-9915   _test_proxy
 10422-10438  _testpush_resolve_live
  7508-7529   _tg_sprache_setzen
  8226-8236   _tg_topics_load_into_mem
  8223-8224   _tg_topics_path
  8238-8245   _tg_topics_save
  9226-9234   _token_ok
  8248-8252   _topic_forget
 11772-11783  _tracking_max_duration
  4037-4051   _tracking_remove_cleanup
  4068-4080   _tracking_resume_cleanup
  1599-1622   _try_attach_file_handler
 18809-18817  _tts_cleanup
 10398-10402  _tunnel_effective
 18305-18358  _twitch_channel_status
 21673-21818  _twitch_chat_loop
 20777-20790  _twitch_clip_versuchen
 21487-21590  _twitch_eventsub_loop
  1380-1393   _upload_queue_add
  1404-1406   _upload_queue_count
  1363-1372   _upload_queue_load
  1353-1355   _upload_queue_path
  1395-1402   _upload_queue_remove
  1374-1378   _upload_queue_save
  1408-1449   _upload_window_loop
  7207-7214   _uptime_s
 12079-12088  _url_host
   849-853    _usage_record_claude
 23133-23155  _v37_pause_source
 23097-23107  _v37_restream_restart
 23110-23130  _v37_unpause_source
  7446-7490   _verbindung_verloren
  6297-6328   _viewer_sample_loop
  9315-9318   _wants_html
  7217-7231   _warn_empty_env
 22753-22874  _watchdog_loop
 21208-21216  _wchat_thank_ok
 16552-16582  _whisper_get_model
  7304-7311   _whisper_native_section
 15744-15750  _whisper_pool
 16676-16708  _whisper_segments
 16584-16600  _whisper_stumm
 16603-16673  _whisper_transcribe
 12485-12647  _write_restream_overlay
 12447-12482  _write_restream_overlay_async
 21842-21938  _youtube_api_chat_loop
 18361-18464  _youtube_api_status
 18467-18534  _youtube_channel_status
 21941-22102  _youtube_chat_loop
 20793-20818  _youtube_clip_versuchen
 21068-21081  _youtube_restream_autoconfig
 21084-21108  _youtube_restream_autoconfig_inner
 21175-21203  _youtube_send
 18602-18643  _youtube_set_channel
 21111-21145  _yt_access_token
 21148-21163  _yt_live_chat_id
 21171-21172  _yt_sendrate_cfg
 21821-21836  _yt_timeout
  2867-2868   _ytdlp_detect_available
  2870-2881   _ytdlp_note_result
 11346-11348  _zombie_child_count
  7083-7107   about
  3948-3952   add_ai_log_entry
  3865-3868   add_archive_entry
  4545-4547   add_archive_rule
  4285-4356   add_recording
  4012-4029   add_tracking
  5688-5721   ai
  3538-3611   ai_chat
  3645-3655   ai_history_append
  3657-3662   ai_history_clear
  3634-3643   ai_history_load
  3619-3632   ai_rate_limit_check
  5750-5758   aireset
 16083-16102  azrael_chat
 22107-22229  brain_cmd
  3170-3175   build_recording_cmd
  4032-4035   bulk_add_trackings
  6551-6610   bulkadd
  8066-8206   check_all_trackings
  4084-4096   claim_live_transition
 15083-15676  class KickModerator
 13383-14846  class RestreamManager
 10281-10323  classify_proxy_anonymity
  5796-5994   cleanup
  4835-4841   cleanup_old_recordings
  4230-4237   clear_recording
 20821-20890  clip_moment
  4497-4500   compute_storage_forecast
  6673-6746   cookies_cmd
  4003-4009   count_trackings_for_chat
  3935-3946   decide_preferred_recorder
  3875-3878   delete_archive_entry
  4549-4551   delete_archive_rule
  5225-5372   diag
 22341-22402  einnahmen_cmd
  4491-4494   find_recordings_by_fingerprint
  3896-3912   finish_recording_attempt
  4056-4058   get_all_active_trackings
  3963-3965   get_all_checks
  4358-4361   get_all_recordings
  4440-4442   get_all_tags_with_counts
  4468-4471   get_annotations_for_recording
  3870-3873   get_archive_entry
  4461-4464   get_bookmarked_recordings
  2077-2082   get_cookie_health
  4428-4434   get_event_log
  3919-3933   get_last_recording_attempt
  2953-3091   get_live_status
  4774-4777   get_manual_recordings
  4476-4479   get_or_compute_inspect_sync
  4876-4879   get_outcome_breakdown
  4447-4450   get_priority_poll_interval
  3914-3917   get_recent_recording_attempts
  4363-4366   get_recording_by_id
  4454-4457   get_recording_note
  3339-3362   get_redis
  3992-3995   get_stats
  4829-4833   get_storage_stats
  4569-4571   get_tiktok_status_distribution
  4098-4107   get_tracking_state
  4053-4054   get_trackings_for_group
  4790-4793   get_trash_recordings
  8607-9061   handle_recording_finished
  3760-3820   init_db
  4541-4543   list_archive_rules
  5029-5067   live
  7586-7594   live_check_worker
  3417-3451   llm_chat
  3474-3502   llm_chat_sync
  3459-3471   llm_list_models
  4387-4420   log_event
  1667-1700   log_recording_failure
  6896-6945   logs_cmd
 23360-23655  main
  5724-5747   on_ai_media
  7022-7048   on_ai_reply
  7051-7080   on_azrael_mention
  7112-7142   on_callback
 16108-16212  oracle_handle
  6785-6788   pause_tracking
  4889-4894   profile_keyboard
  6847-6893   quota
  7970-8044   reaper_loop
  4565-4567   record_tiktok_status
  5763-5793   recstatus
  3364-3372   redis_get_json
  3375-3381   redis_set_json
 22405-22415  report_cmd
 10326-10328  report_proxy_result
  2353-2395   resolve_tiktok_live_stream
  4785-4788   restore_recording
  6791-6794   resume_tracking
  4554-4559   run_archive_rules
 22418-22660  run_bot
 11198-11292  run_flask
  4529-4532   sample_bandwidth_for_active
  3955-3961   save_tiktok_check
  4222-4228   set_recording_file
  4061-4065   set_tracking_paused
  4780-4783   soft_delete_recording
  8359-8369   split_and_send_video
  4942-4984   start
  3880-3894   start_recording_attempt
  5997-6035   stats
  4719-4772   stop_manual_recording
  6797-6844   stoprec
  6221-6229   summary_cmd
  6948-7019   sysres
  5374-5518   teststream
  4986-5027   tiktok
  6613-6670   topusers
  5104-5161   track
  5069-5101   track_exact
  5175-5223   tracklist
  4603-4717   trigger_manual_recording
  4183-4220   try_acquire_recording_lock
  4796-4798   universal_search
  5163-5173   untrack
 22232-22338  update_cmd
  4486-4489   update_recording_fingerprint
```
