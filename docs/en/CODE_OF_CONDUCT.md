...
> 🌐 **English** · [Deutsch](../CODE_OF_CONDUCT.md)

*(Contributor Covenant v2.1 — canonical English text)*
...
reported to the community leaders through the contact routes listed in the
repository — confidentially by e-mail to the repository owner if needed. All
...
behavior deemed unprofessional or unwelcome.
...
of community standards, harassment of an individual, or aggression toward or
