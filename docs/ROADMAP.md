...
28.935 Zeilen**. Die Datei ist der Engpass des Projekts — sie lässt sich nicht
...
Welle 2 ist erledigt, Welle 3 läuft: `nc/routes/` trägt heute 25 Blueprints mit
225 API-Routen, die nicht mehr im Monolithen stehen.
