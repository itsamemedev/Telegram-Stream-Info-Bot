...
26.919 Zeilen**. Die Datei ist der Engpass des Projekts — sie lässt sich nicht
...
Welle 2 ist erledigt, Welle 3 läuft: `nc/routes/` trägt heute 32 Blueprints mit
288 API-Routen, die nicht mehr im Monolithen stehen.
