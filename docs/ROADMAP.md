...
31.689 Zeilen**. Die Datei ist der Engpass des Projekts — sie lässt sich nicht
...
Welle 2 ist erledigt, Welle 3 läuft: `nc/routes/` trägt heute 11 Blueprints mit
129 API-Routen, die nicht mehr im Monolithen stehen.
