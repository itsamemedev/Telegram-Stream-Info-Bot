...
27.624 Zeilen**. Die Datei ist der Engpass des Projekts — sie lässt sich nicht
...
Welle 2 ist erledigt, Welle 3 läuft: `nc/routes/` trägt heute 30 Blueprints mit
270 API-Routen, die nicht mehr im Monolithen stehen.
