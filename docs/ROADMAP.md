...
26.805 Zeilen**. Die Datei ist der Engpass des Projekts — sie lässt sich nicht
...
Welle 2 ist erledigt, Welle 3 läuft: `nc/routes/` trägt heute 33 Blueprints mit
292 API-Routen, die nicht mehr im Monolithen stehen.
