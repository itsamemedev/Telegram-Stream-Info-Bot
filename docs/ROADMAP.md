...
29.437 Zeilen**. Die Datei ist der Engpass des Projekts — sie lässt sich nicht
...
Welle 2 ist erledigt, Welle 3 läuft: `nc/routes/` trägt heute 20 Blueprints mit
198 API-Routen, die nicht mehr im Monolithen stehen.
