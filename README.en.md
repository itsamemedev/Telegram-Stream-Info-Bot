...
│   ├── routes/               18 Flask blueprints (187 API routes)
...
| Flask routes | 359 (172 in `bot.py` · 187 in `nc/routes/`) |
...
running: `nc/routes/` carries 18 blueprints with 187 API routes today that no
