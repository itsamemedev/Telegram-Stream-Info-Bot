...
flowchart TB
    ...
    BOT["bot.py<br/>monolith · 29,357 lines<br/>scraper · recorder · restream<br/>Flask dashboard · 153 own routes"]:::core
...
`bot.py` has 29,357 lines. It is **never** read in full and **never** searched
...
The next big step is not a feature, it is cleaning up: **`bot.py` has 29,357
